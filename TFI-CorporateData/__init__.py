...
conn_str = "DRIVER={ODBC Driver 17 for SQL Server};SERVER=tcp:sql-apio-any.database.windows.net;DATABASE=db-apio-any;UID=sqladmin;PWD=Apio2021@"
id_Prefix = "1GBJ7T1C1YJ51"
